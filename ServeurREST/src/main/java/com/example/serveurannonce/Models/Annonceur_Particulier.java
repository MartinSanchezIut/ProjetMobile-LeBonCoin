...
public class Annonceur_Particulier extends User {
    ...
    public Annonceur_Particulier(String statu,String pseudo,String Image , String nom, String prenom, String email, String numero, String mot_de_passe){//, List<Annonce> mesannonces) {
